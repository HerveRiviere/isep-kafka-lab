...
\item Will be grade with letter notation : A+ : fully completed with good answers and bonus part / A : Fully completed without the bonus part / B : Partially completed or some incorrect answers / C : not received.
...
\begin{enumerate}
    \item by Microsoft Team chat  : during the lab
    \item by email (rivere.herve.isep@gmail.com) : after the lab
\end{enumerate}
