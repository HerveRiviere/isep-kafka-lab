...
You should be able to observe the number of messages in your topic (you can click on graph to get the metric history) and get the broker_id receiving the load (if needed scroll down the page to see the graph legend)
